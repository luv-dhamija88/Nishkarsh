-- Versioned raw telemetry storage schema for incident-processor.
--
-- Design goals:
...
--
-- NOTE: Create future monthly partitions via scheduled job (or pg_partman) in production.
...
-- Example monthly partitions for the current bootstrap month.
